			...
			<div class="navbar-collapse collapse" id="navbar-navigation">
				<ul class="navbar-nav navbar-nav-highlight">
					<li class="nav-item" v-for="(m,mIndex) in menu" :index="m.modul.nama" :key="m.modul.nama" v-if="m.modul.type == 'main'">
						<router-link :to="{ name: m.modul.url}" class="navbar-nav-link" :class="{ active : (activeLink === m.modul.nama)}" replace>
							<i :class="m.modul.icon"></i>
							{{m.modul.nama}}
						</router-link>
					</li>
					<li class="nav-item dropdown" v-for="(m,mIndex) in menu" :index="m.modul.nama" :key="m.modul.nama" v-if="m.modul.type == 'parent'">
						
						<a href="#" class="navbar-nav-link dropdown-toggle" :class="{ active : (activeLink === m.modul.nama)}" data-toggle="dropdown">
							<i :class="m.modul.icon"></i>
							{{m.modul.nama}}
						</a>
						...
						<div class="dropdown-menu">
							<router-link 
							v-for="(c,CIndex) in menu" :index="c.modul.nama" :key="c.modul.nama" v-if="c.modul.type == 'child' && c.modul.parent_id == m.modul.modul_id"
							:to="{ name: m.modul.nama+'-'+c.modul.url}"  class="dropdown-item" :class="{ active : (activeLink === c.modul.nama)}" replace>
